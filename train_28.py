...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--train_model", default="DNM_Linear", type=str, help="use model") # ICFC
    ...
    for run in range(run_times):
        ...
        for epoch in range(epochs):
            ...
            if current_val_acc > best_val_acc or current_val_loss<best_val_loss:
                ...
                save_path = os.path.join(model_save_path, data_name+"_"+model_name+"_"+str(hidden_size)+"_M"+str(M)+"_"+str(run)+".pth")
